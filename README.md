...
### 本软件使用到的项目：<br>
1.EGE:https://github.com/x-ege/xege<br>
2.FFMPEG:https://github.com/FFmpeg/FFmpeg<br>
3.(GNU)Libiconv:https://www.gnu.org/software/libiconv/<br>
4.Uchardet:https://www.freedesktop.org/wiki/Software/uchardet/<br>
5.ASCII-Image-Converter:https://github.com/TheZoraiz/ascii-image-converter<br><br>
### 开发和重新编译本软件需注意点：<br>
1.此软件在Windows11/10/7上均可开发<br>
2.本软件使用C++编写，使用了EGE图形库，使用小熊猫C++(IDE)开发，因此建议您也[下载此IDE](http://royqh.net/redpandacpp/download/)以更加便利地开发软件。<br>
3.为了适配32位电脑，请勿替换FFMPEG等内置软件，因为FFMPEG官方已不再支持32位电脑，只能使用此版本。<br>
4.这是我使用的编译选项：<br>
mingw32-make.exe -j1 -f makefile.win all<br>
"g++.exe" -c "main.cpp" -o "main.o"  "-g3" "-O2" "-pipe" "-Wall" "-lcomdlg32" "-D_DEBUG"  -finput-charset=UTF-8 -fexec-charset=gbk<br>
"windres.exe" -i "v3_private.rc" --input-format=rc -o "v3_private.res" -O coff  <br>
"g++.exe" "main.o" "v3_private.res" -o "v3.0.1.exe" "-Wl,--stack,12582912" "-mwindows" "-lgraphics" "-luuid" "-lmsimg32" "-lgdi32" "-limm32" "-lole32" "-loleaut32" "-lwinmm" "-lgdiplus"<br>